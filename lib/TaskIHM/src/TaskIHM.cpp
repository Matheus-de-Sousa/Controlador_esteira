    ...
    for(;;)
    {
        ...
        switch(LCD_Mode)
        {
            ...
            case 1:
                ...
                hd44780_puts(&lcd,lcdData.c_str());
                ESP_LOGI(GetName().c_str(), "%s", lcdData.c_str());
                lcdData = "SensorIR:" + std::to_string(sharedTemp.StatusPecas);
        ...
        xTaskDelayUntil(&xLastTimeWake, 500 / portTICK_PERIOD_MS);
    }
